...
public class UpiaKeTestLogin extends BaseTest {

    @Test
    public void testLogin() {

        loadLink(CommonMappings.URL_UPIA_KE);
        ...
        enterText(ID, ObjectMappingsRepository.NAME_PASSWORD, CommonMappings.VALUE_PASSWORD);
        ...
        assertTest(AssertExpectedMappings.LANDING_PAGE_URL_UPIA_KE, loadedUrl);
    }
    ...
    public void testNavigationToResetPasswordPage() {
        ...
        //get current url
        String loadedUrl = getCurrentUrl();
        String expectedUrl = CommonMappings.URL_UPIA_KE_RESET_PASSWORD;
